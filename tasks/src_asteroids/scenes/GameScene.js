class GameScene extends Phaser.Scene {
    ...
    update() {
        ...
        this.score.setText('Schutzschilder:\n\n'  +
            '\n\nPunktzahl:\n' + this.scoreVal);
...
collide(bodyA, bodyB, axis, context)
    ...
    nextPhase() {
        ...
        //eventuell später weiterverwenden zum rauslinken?
       /* if (parseFloat(this.cache.game.taskversion) % 2 == 0) {
            this.scene.start('NextPhase', {score: this.scoreVal, topScore: this.topScore});
        }
        else {
            this.scene.start('RewardStart', {score: this.scoreVal, topScore: this.topScore});
        }*/
    }
}
